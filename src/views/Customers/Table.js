...
const headCells = [
  ...
  { id: 'accountNumber', numeric: false, disablePadding: true, label: 'Số tài khoản' },
  { id: 'accountName', numeric: false, disablePadding: true, label: 'Tên tài khoản' },
  { id: 'username', numeric: false, disablePadding: true, label: 'Tên đăng nhập' },
  { id: 'initialPassword', numeric: false, disablePadding: true, label: 'Mật khẩu khởi tạo' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.initialPassword}</TableCell>
